...
- Name: analytics.spec.ts >> Analytics & Insights >> "PDF" download button is visible in the header
- Location: tests\analytics.spec.ts:93:7
...
Locator: getByRole('button', { name: /^pdf$/i })
Expected: visible
Timeout: 5000ms
